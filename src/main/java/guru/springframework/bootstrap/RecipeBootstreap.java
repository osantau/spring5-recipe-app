...
@Component
public class RecipeBootstreap implements ApplicationListener<ContextRefreshedEvent> {

	private final CategoryRepository categoryRepository;
	private final RecipeRepository recipeRepository;
	private final UnitOfMeasureRepository unitOfMeasureRepository;

	public RecipeBootstreap(CategoryRepository categoryRepository, RecipeRepository recipeRepository,
